...
const swaggerOptions = {
  definition: {
    openapi: "3.0.3",
    info: {
      title: "API интернет-магазина с авторизацией и refresh-токенами",
      version: "1.0.0",
      description:
        "REST API с регистрацией пользователей, refresh-токенами и CRUD-операциями для товаров",
    },
    servers: [
 ...
 *     tags: [Auth]
 *     description: Проверяет email и пароль пользователя, выдает пару JWT (access + refresh)
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     tags: [Auth]
 *     description: Принимает refresh-токен и генерирует новую пару access + refresh токенов
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
