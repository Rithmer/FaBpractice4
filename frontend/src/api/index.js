...
export const api = {
  ...
  updateUser: async (id, user) =>
    (await apiClient.put(`/users/${id}`, user)).data,
  blockUser: async (id) => (await apiClient.delete(`/users/${id}`)).data,

  createOrder: async (items) => (await apiClient.post("/orders", { items })).data,
  getMyOrders: async () => (await apiClient.get("/orders/my")).data,
  getAllOrders: async () => (await apiClient.get("/orders")).data,
};
