    ...
    <div className="page">
      ...
      <main className="main">
        <div className="container">
          ...
          <div className="stats">
            Показано: <strong>{filtered.length}</strong> из <strong>{products.length}</strong> товаров
          </div>
      ...
      <footer className="footer">
        <div className="footer__inner">© {new Date().getFullYear()} ТехМаркет — все права защищены</div>
      </footer>
