...
function unwrapCachedPayload(payload) {
  if (
    payload &&
...
export const api = {
  ...
  getProducts: async () => unwrapCachedPayload((await apiClient.get("/products")).data),
  getProductById: async (id) =>
    unwrapCachedPayload((await apiClient.get(`/products/${id}`)).data),
  ...
  getUsers: async () => unwrapCachedPayload((await apiClient.get("/users")).data),
  getUserById: async (id) =>
    unwrapCachedPayload((await apiClient.get(`/users/${id}`)).data),
