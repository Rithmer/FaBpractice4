...
// Ленивая загрузка BooksPage — подгружается только при переключении на вкладку
      ...
      <main className="main">
        <div className="container">
          ...
          <div className="sectionTabs">
            ...
            {/* Вкладка GraphQL-каталога книг (Практика 26) */}
            <button
          ...
          {/* ── Библиотека (GraphQL + Apollo Client) ── */}
          {activeTab === "books" && (
            <Suspense fallback={<div className="empty">Загрузка библиотеки...</div>}>
              <BooksPage />
            </Suspense>
          )}
